    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="relative h-64 bg-indigo-900">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 max-w-7xl mx-auto">
          <Link to="/buyer/prices" className="text-white opacity-80 hover:opacity-100 flex items-center mb-4 text-sm font-medium">
             <ArrowLeftIcon className="h-4 w-4 mr-2" />
             Back to Markets
          </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
           ...
           <p className="text-gray-500 mt-1">Explore what {market.name} is selling today by category.</p>
        </div>
            ...
            {sortedCategories.map((category) => (
              <div key={category} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div className="bg-gray-50 px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                  ...
                  <span className="bg-white px-2 py-1 rounded text-xs font-medium text-gray-500 border border-gray-200">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 p-6">
                   {pricesByCategory[category].map((item) => (
                     <div key={item.$id} className="flex items-start space-x-4 group">
                        <div className="flex-shrink-0 h-16 w-16 rounded-lg overflow-hidden bg-gray-100 border border-gray-100">
                          <img 
