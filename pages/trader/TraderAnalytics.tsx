            ...
            >
              ...
              <div className="relative z-10 h-full p-4 flex flex-col justify-between text-white">
                ...
                <div>
                   ...
                   <p className="text-sm font-semibold mt-1">Avg: ₦{stat.avgPrice.toFixed(2)}</p>
                </div>
              </div>
            </button>
          ))}
                      ...
                      <div className="flex items-center">
                         ...
                         <div className="ml-5 w-0 flex-1">
                            <dl>
                               ...
                               <dd>
                                  <div className="text-lg font-medium text-gray-900">₦{market.avg.toFixed(2)} <span className="text-xs text-gray-500 font-normal">avg</span></div>
                               </dd>
                            </dl>
                         </div>
                      </div>
